% =============================================================================
% Architectural Model Feature Percentile Analysis
% =============================================================================
clear; clc; close all;
...
% Extract scale indicators from project name
...
% Helper function to locate column names safely
findColumn = @(pattern, label) locateColumn(all_vars, pattern, label);

paint_masonry_col = findColumn('paintingmasonry', 'painting masonry');
paint_wood_col = findColumn('paintingwood', 'painting wood');
paint_metal_col = findColumn('paintingmetal', 'painting metal');
chb_100_col = findColumn('chb100mm', 'CHB 100mm');
chb_150_col = findColumn('chb150mm', 'CHB 150mm');
plaster_col = findColumn('plaster', 'plaster');
tiles_col = findColumn('glazedtiles', 'glazed tiles');
...
ratio_fields = {'plaster_per_chb', 'tiles_per_chb'};
...
try
    load('architectural_model_assets.mat', 'optimized_model', 'selected_mask', 'poly_feature_names');
...
% Helper Function
% =============================================================================
function colName = locateColumn(allVars, pattern, label)
